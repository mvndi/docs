...
**3.4 A town's spawn (where the siege banner is moved to after assembly) must be accessible to attackers via siege weapons.** (if its in some aids place to reach like suuper above ground or suuper above ground jannies will just end the siege in attacker victory)
