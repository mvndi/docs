...
**3.9 A town's spawn (where the siege banner is moved to after assembly) must be accessible to attackers via siege weapons.**

**3.10 No surrounding of towns with other towns.**

**3.11 Always put the siege banner at the general height of the town, and where the enemy can, absent your army, reach it without difficulty.**
...
**4.5 Using boats to bypass fall damage or glide into an enemies walls is not allowed.**
